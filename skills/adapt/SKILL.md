---
name: adapt
description: Use when the user mentions responsive design, mobile layouts, breakpoints, viewport adaptation, fluid layouts, touch targets, or making a design work across different screen sizes, devices, or platforms.

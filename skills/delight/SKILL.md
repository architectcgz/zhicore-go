---
name: delight
description: Use when the user asks to add polish, personality, delight, animations, micro-interactions, or make an interface feel fun, memorable, and enjoyable to use.

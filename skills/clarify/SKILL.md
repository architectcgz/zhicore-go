---
name: clarify
description: Use when the user mentions confusing text, unclear labels, bad error messages, microcopy, hard-to-follow instructions, or wanting better UX writing.

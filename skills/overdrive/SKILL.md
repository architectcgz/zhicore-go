---
name: overdrive
description: Use when the user wants to wow, impress, go all-out, or make something extraordinary with technically ambitious implementations like shaders, spring physics, scroll-driven reveals, and 60fps animations.

---
name: arrange
description: Use when the user mentions layout feeling off, spacing issues, visual hierarchy, crowded UI, monotonous grids, inconsistent spacing, alignment problems, or wanting better composition and visual rhythm.

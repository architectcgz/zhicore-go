---
name: animate
description: Use when the user mentions adding animation, transitions, micro-interactions, motion design, motion effects, hover effects, or making the UI feel more alive.

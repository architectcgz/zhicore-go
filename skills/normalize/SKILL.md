---
name: normalize
description: Use when the user mentions consistency, design drift, mismatched styles, tokens, or wants to realign a feature with the design system's standards, spacing, and patterns.

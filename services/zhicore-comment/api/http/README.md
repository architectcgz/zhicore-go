...
| `GET` | `/api/v1/posts/{postId}/comments/{commentId}` | API 族已识别 |
| `PUT` | `/api/v1/posts/{postId}/comments/{commentId}` | API 族已识别 |
| `DELETE` | `/api/v1/posts/{postId}/comments/{commentId}` | API 族已识别 |
| `GET` | `/api/v1/posts/{postId}/comments/{commentId}/replies/page` | API 族已识别 |
...
| `POST` | `/api/v1/posts/{postId}/comments/{commentId}/like` | API 族已识别 |
| `DELETE` | `/api/v1/posts/{postId}/comments/{commentId}/like` | API 族已识别 |
| `GET` | `/api/v1/posts/{postId}/comments/{commentId}/liked` | API 族已识别 |

...
var (
	...
	selectNotificationGroupForMarkReadSQL = mustSQL("select_notification_group_for_mark_read.sql")
	markNotificationGroupReadSQL          = mustSQL("mark_notification_group_read.sql")
	resetSingleGroupUnreadSQL             = mustSQL("reset_single_group_unread.sql")
	decrementNotificationGroupStatsSQL    = mustSQL("decrement_notification_group_stats.sql")
	listNotificationGroupActorsSQL        = mustSQL("list_notification_group_actors.sql")
	ensureNotificationGroupOwnerSQL       = mustSQL("ensure_notification_group_owner.sql")
	lockNotificationGroupByKeySQL         = mustSQL("lock_notification_group_by_key.sql")
	lockAllNotificationGroupsSQL          = mustSQL("lock_all_notification_groups.sql")

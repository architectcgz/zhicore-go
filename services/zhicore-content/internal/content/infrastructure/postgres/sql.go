...
var (
	...
	listAdminPostsSQL                 = mustSQL("list_admin_posts.sql")
	adminDeletePostSQL                = mustSQL("admin_delete_post.sql")
	insertAdminPostAuditSQL           = mustSQL("insert_admin_post_audit.sql")

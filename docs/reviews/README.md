...
完成门槛见 `docs/reviews/done-definition.md`，本地质量门禁和 CI 最低要求见 `docs/reviews/quality-gates.md`，提交信息规范见 `docs/reviews/commit-message.md`。本文件负责 review 流程、记录格式和归档位置。
...
- 跨服务边界、共享库、服务目录结构、脚本检查、本地质量门禁、CI / Git hook、提交信息策略、AGENTS 路由或长期文档事实源变化。

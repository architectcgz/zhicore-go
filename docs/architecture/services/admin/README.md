...
- [frontend pages/admin.md](../../../../../zhicore-frontend-vue/docs/design/pages/admin.md)：Admin 管理端页面初设计、用户 / 内容 / 评论管理、举报处理、审计日志和委托操作状态。

既有管理端路径没有统一 `/api/v1` 前缀，Go 设计需要保持前端当前路径可用，除非另行登记 API 演进。

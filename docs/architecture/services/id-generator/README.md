...
普通业务服务内部主键默认使用各服务数据库 identity。外部公开 ID 和业务编号按各自服务设计。
...
- [frontend pages/id-generator.md](../../../../../zhicore-frontend-vue/docs/design/pages/id-generator.md)：当前无产品页面；仅记录未来恢复集中发号后的内部诊断页占位和约束。

...
**技术栈：** Go 1.22、标准库 `net/http`、PostgreSQL、RabbitMQ outbox、context cancellation。
...
- [ ] **步骤 4：补 runtime module 和 `cmd/server`**

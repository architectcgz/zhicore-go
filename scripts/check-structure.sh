...
required_dirs=(
  ...
  "docs/architecture/services/upload"
...
required_files=(
  ...
  "docs/architecture/services/upload/README.md"
  "docs/architecture/services/upload/service-design.upload.png"
  "docs/architecture/services/upload/service-detail.drawio"
  "docs/architecture/services/upload/service-detail.png"
